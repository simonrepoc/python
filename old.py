...
for hashtag in hashtag_list:
    ...
    sleep(5)
    first_thumbnail = browser.find_element_by_xpath('//*[@id="react-root"]/section/main/article/div[1]/div/div/div[1]/div[1]/a/div')
    ...
    try:        
        for x in range(1,200):
            ...
            if username not in prev_user_list:
                ...
                if browser.find_element_by_xpath('/html/body/div[5]/div[2]/div/article/header/div[2]/div[1]/div[2]/button'):
                    
                    browser.find_element_by_xpath('/html/body/div[5]/div[2]/div/article/div[2]/div/div/div[2]').click()
